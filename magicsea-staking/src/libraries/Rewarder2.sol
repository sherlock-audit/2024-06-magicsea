...
library Rewarder2 {
     ...
     * @param id The address / tokenId / other identifier for an user.
     * @param totalRewards The total rewards.
    ...
    function getPendingReward(
        ...
        return getPendingReward(rewarder, id, amounts.getAmountOf(id), amounts.getTotalAmount(), totalRewards);
    }
    ...
    function getPendingReward(
        ...
        return balance == 0 ? 0 : getDebt(accDebtPerShare, balance) - rewarder.debt[id];
    }
